    ...
    <div class="py-8 border-y border-slate-200 bg-white/50 mb-12">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="flex flex-wrap justify-center items-center gap-8 md:gap-14 opacity-60">
          ...
          <div class="flex flex-col items-center group cursor-help">
            <span class="text-xl font-black text-slate-700 group-hover:text-[#F80000] transition-colors tracking-tight">PL/SQL</span>
            <span class="text-[10px] text-slate-400 font-medium tracking-widest mt-1">ORACLE DATA</span>
          </div>

          <div class="flex flex-col items-center group cursor-help">
            <span class="text-xl font-extrabold text-slate-700 group-hover:text-[#3776AB] transition-colors">PYTHON</span>
            <span class="text-[10px] text-slate-400 font-medium tracking-widest mt-1">DATA & IA</span>
          </div>

          <div class="flex flex-col items-center group cursor-help">
            <span class="text-xl font-black text-slate-700 group-hover:text-[#DD0031] transition-colors tracking-tighter">ANGULAR</span>
            <span class="text-[10px] text-slate-400 font-medium tracking-widest mt-1">FRONTEND</span>
          </div>

          <div class="flex flex-col items-center group cursor-help">
            <span class="text-xl font-black text-slate-700 group-hover:text-[#FC6D26] transition-colors tracking-tight">GITLAB / JENKINS</span>
            <span class="text-[10px] text-slate-400 font-medium tracking-widest mt-1">DEVOPS CI-CD</span>
          </div>
